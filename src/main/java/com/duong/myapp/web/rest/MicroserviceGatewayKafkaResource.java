...
public class MicroserviceGatewayKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MicroserviceGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroserviceGatewayKafkaResource(KafkaProperties kafkaProperties) {
