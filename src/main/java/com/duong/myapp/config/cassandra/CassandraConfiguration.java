package com.duong.myapp.config.cassandra;
...
public class CassandraConfiguration {
    ...
    ClusterBuilderCustomizer clusterBuilderCustomizer(CassandraProperties properties) {
        return builder -> builder.withProtocolVersion(protocolVersion).withPort(getPort(properties)).withoutJMXReporting().withoutMetrics();
    }
